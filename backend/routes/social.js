...
router.get('/meta/:postId', async (req, res) => {
  try {
    ...
    const metaData = {
      ...
      image: post.coverImage || extractFirstImageFromContent(post.content) || `${frontendUrl}/src/assets/images/BlackAndBeigeFeminineHowToWebsiteBlogBanner.jpg`,
...
router.get('/og-image/:postId', async (req, res) => {
  try {
    ...
    const imageUrl = post.coverImage || 
                    ...
                    `${process.env.FRONTEND_URL || 'https://elankodse.com'}/src/assets/images/BlackAndBeigeFeminineHowToWebsiteBlogBanner.jpg`;
