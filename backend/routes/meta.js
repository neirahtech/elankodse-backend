...
router.get('/post/:id', async (req, res) => {
  try {
    ...
    const metaData = {
      ...
      url: `https://elankodse.com/post/${postData.postId}`,
      type: 'article',
...
router.get('/post/:id/preview', async (req, res) => {
  try {
    ...
    const metaData = {
      title: postData.title || 'Elanko | தமிழ் இலக்கியம்',
      description: metaDescription,
      image: metaImage || 'https://elankodse.com/src/assets/images/BlackAndBeigeFeminineHowToWebsiteBlogBanner.jpg',
      url: `https://elankodse.com/post/${postData.postId}`,
      type: 'article',
      author: postData.author || 'Elanko',
      publishedTime: postData.publishedAt || postData.date,
...
router.get('/book/:id', async (req, res) => {
  try {
    ...
    const metaData = {
      ...
      url: `https://elankodse.com/book/${bookData.id}`,
      type: 'book',
