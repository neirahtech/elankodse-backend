  ...
  <head>
    ...
    <script>
      ...
      if (!navigator.userAgent.includes('bot') && !navigator.userAgent.includes('crawler')) {
        window.location.href = 'http://localhost:5173/post/${metaData.url.split('/').pop()}';
      }
    </script>
  </head>
  <body>
    <div style="font-family: Arial, sans-serif; max-width: 800px; margin: 50px auto; padding: 20px; text-align: center;">
      ...
      <noscript>
        <a href="http://localhost:5173/post/${metaData.url.split('/').pop()}" style="color: #1e40af; text-decoration: none; font-weight: bold;">
...
<html lang="ta">
  <head>
    ...
    <script>
      ...
      // For real users, redirect to the frontend React app
      if (!navigator.userAgent.includes('bot') && !navigator.userAgent.includes('crawler')) {
        window.location.href = 'http://localhost:5173/book/${metaData.url.split('/').pop()}';
      }
    </script>
  </head>
  <body>
    <div style="font-family: Arial, sans-serif; max-width: 800px; margin: 50px auto; padding: 20px; text-align: center;">
      ...
      <noscript>
        <a href="http://localhost:5173/book/${metaData.url.split('/').pop()}" style="color: #1e40af; text-decoration: none; font-weight: bold;">
